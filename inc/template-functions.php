 ...
 * @return array
 */
function escapedance_body_classes( $classes ) {
	...
	if ( is_customize_preview() ) {
		$classes[] = 'escapedance-customizer';
	}

	// Add class on front page.
	if ( is_front_page() && 'posts' !== get_option( 'show_on_front' ) ) {
		$classes[] = 'escapedance-front-page';
	}
...
add_filter( 'body_class', 'escapedance_body_classes' );
 ...
 */
function escapedance_is_frontpage() {
