<?php
/**
 * Escape Dance Holiday: Color Patterns
 *
 * @package WordPress
 ...
 */
function escapedanceholiday_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Escape Dance Holiday default saturation level.
	 *
	 * @since Escape Dance Holiday 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'escapedanceholiday_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.escapedanceholiday-front-page) .entry-title,
...
.colors-custom .escapedanceholiday-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.escapedanceholiday-front-page .panel-content .recent-posts article,
...
.colors-custom.escapedanceholiday-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Escape Dance Holiday custom colors CSS.
	 *
	 * @since Escape Dance Holiday 1.0
	 *
	 ...
	 */
	return apply_filters( 'escapedanceholiday_custom_colors_css', $css, $hue, $saturation );
}
